...
namespace Contract.Controllers
{
    [ApiController]
    [Route("[controller]")]
    public class OLDContractController : ControllerBase
    {
        private readonly ILogger<OLDContractController> _logger;
        public RabbitMQService _publisher { get; set; }

        public OLDContractController(ILogger<OLDContractController> logger, RabbitMQService publisher)
        {
            _logger = logger;
